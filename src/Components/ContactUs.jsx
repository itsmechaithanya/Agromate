  ...
  return (
    <div className='pt-[11vh] '>
      <div className=' lg:h-[50vh] h-[25vh] flex items-center pl-[5vw]'>
        <h1 className='text-[#2F2F69] capitalize lg:text-[4.5vw] text-[4.5vh]  font-bold '>Get In Touch with <br />the Best  <i class="ri-arrow-right-down-line"></i></h1>
      </div>
      <div>
        <div className='bg-slate-100 px-[5vw] lg:pt-[7vw]  h-[100vh] w-screen rounded-t-[5vw]'>
        <h1 className='pl-[1vw] lg:pl-[0vw] font-medium lg:text-[1.5vw] pt-[5vh] lg:pt-[0vh]'>NGE Agromate Private Limited</h1>
      ...
      <div className='flex justify-center lg:mt-[28vh] mt-[42vh]'>
